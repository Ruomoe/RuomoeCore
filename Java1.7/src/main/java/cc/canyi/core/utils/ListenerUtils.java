...
public class ListenerUtils {
    ...
    public static void registerListener(Plugin mainPlugin, Listener listener) {
        SavedListeners savedListeners = registered_listeners.containsKey(mainPlugin) ? registered_listeners.get(mainPlugin) : new SavedListeners(mainPlugin.getClass(), new LinkedHashSet<Listener>());
